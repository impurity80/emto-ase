...
def EC_FCC_C(work_dir, atoms, calc, OPTIONS = np.linspace(0.00, 0.05, 6)):
...
def EC_FCC_C44(work_dir, atoms, calc, OPTIONS = np.linspace(0.00, 0.05, 6)):
    ...
    for o in OPTIONS:
        ...
        dist = [[1 + o, 0, 0], [0, 1 - o, 0], [0, 0, np.sqrt(2) / (1 - o ** 2)]]
